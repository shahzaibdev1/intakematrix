...
export const metadata: Metadata = {
  title: "IntakeMatrix | Autonomous Patient Intake Infrastructure",
  description:
    "Eliminate missed-call revenue leaks and automate your patient intake pipeline with developer-grade clinic infrastructure.",
};
